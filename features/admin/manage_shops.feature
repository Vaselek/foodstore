Feature: Manage Shops
	...
	Scenario: Destroy Shop
		...
		And I have 8 shops
		And I am on the list of shop
		When I follow "Delete" for the shop with css id "shop_1"
	...
	Scenario: Edit Shop
		...
		And I have 8 shops
		And I am on the list of shop
		When I follow "Edit" for the shop with css id "shop_1"
	...
	Scenario: View Shop
		...
		And I have 8 shops
		And I am on the list of shop
		When I follow "View" for the shop with css id "shop_1"
		Then I am on the view page of shop with id 1
